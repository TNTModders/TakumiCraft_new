...
public class TCVoidCreeper extends AbstractTCCreeper {
    ...
    public static class TCVoidCreeperContext implements TCCreeperContext<TCVoidCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCVoidCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
