...
public class TCLostCreeper extends AbstractTCCreeper {
    ...
    public static class TCLostCreeperContext implements TCCreeperContext<TCLostCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCLostCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
