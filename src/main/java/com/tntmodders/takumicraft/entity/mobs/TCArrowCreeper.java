...
public class TCArrowCreeper extends AbstractTCCreeper {
    ...
    public static class TCArrowCreeperContext implements TCCreeperContext<TCArrowCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCArrowCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
