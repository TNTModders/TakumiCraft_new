...
public class TCBreezeCreeper extends AbstractTCCreeper {
    ...
    public static class TCBreezeCreeperContext implements TCCreeperContext<TCBreezeCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCBreezeCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.77F).eyeHeight(1.3452F).clientTrackingRange(10).build(TCEntityCore.TCEntityId(NAME));
