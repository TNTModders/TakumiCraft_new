...
public class TCPierceCreeper extends AbstractTCCreeper {
    ...
    public static class TCPierceCreeperContext implements TCCreeperContext<TCPierceCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCPierceCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(16).build(TakumiCraftCore.MODID + ":" + NAME);
