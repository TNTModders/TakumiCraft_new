...
public class TCArtCreeper extends AbstractTCCreeper {
    ...
    public static class TCArtCreeperContext implements TCCreeperContext<TCArtCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCArtCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
