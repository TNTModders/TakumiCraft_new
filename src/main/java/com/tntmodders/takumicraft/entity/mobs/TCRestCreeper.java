...
public class TCRestCreeper extends AbstractTCCreeper {
    ...
    public static class TCRestCreeperContext implements TCCreeperContext<TCRestCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCRestCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityUtils.TCEntityId(NAME));
