...
public class TCEmeraldCreeper extends AbstractTCCreeper {
    ...
    public static class TCEmeraldCreeperContext implements TCCreeperContext<TCEmeraldCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCEmeraldCreeper::new, MobCategory.MONSTER).sized(1.2F, 3.4F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
