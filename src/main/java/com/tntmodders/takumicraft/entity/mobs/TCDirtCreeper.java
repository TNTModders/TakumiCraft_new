...
public class TCDirtCreeper extends AbstractTCCreeper {
    ...
    public float getBlockExplosionResistance(Explosion explosion, BlockGetter wolrdIn, BlockPos pos, BlockState blockStateIn, FluidState p_19996_, float p_19997_) {
        return blockStateIn.isAir() || blockStateIn.is(BlockTags.MINEABLE_WITH_SHOVEL) ? 0f : super.getBlockExplosionResistance(explosion, wolrdIn, pos, blockStateIn, p_19996_, p_19997_) * 10f;
    }
    ...
    public static class TCDirtCreeperContext implements TCCreeperContext<TCDirtCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCDirtCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
