...
public class TCDirtCreeper extends AbstractTCCreeper {
    ...
    public static class TCDirtCreeperContext implements TCCreeperContext<TCDirtCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCDirtCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
