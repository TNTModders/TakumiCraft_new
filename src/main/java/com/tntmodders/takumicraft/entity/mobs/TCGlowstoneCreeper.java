...
public class TCGlowstoneCreeper extends AbstractTCCreeper {
    ...
    public static class TCGlowstoneCreeperContext implements TCCreeperContext<TCGlowstoneCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCGlowstoneCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
