...
public class TCWoodCreeper extends AbstractTCCreeper {
    ...
    public static class TCWoodCreeperContext implements TCCreeperContext<TCWoodCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCWoodCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
