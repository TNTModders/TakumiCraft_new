...
public class TCPotatoCreeper extends AbstractTCCreeper {
    ...
    public static class TCPotatoCreeperContext implements TCCreeperContext<TCPotatoCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCPotatoCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityUtils.TCEntityId(NAME));
