...
public class TCCatCreeper extends AbstractTCCreeper {
    ...
    public static class TCCatCreeperContext implements TCCreeperContext<TCCatCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCCatCreeper::new, MobCategory.MONSTER).sized(0.6F, 0.7F).eyeHeight(0.35F).passengerAttachments(0.5125F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
