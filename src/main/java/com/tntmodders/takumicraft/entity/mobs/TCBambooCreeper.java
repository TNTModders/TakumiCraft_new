...
public class TCBambooCreeper extends AbstractTCCreeper {
    ...
    public static class TCBambooCreeperContext implements TCCreeperContext<TCBambooCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCBambooCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
