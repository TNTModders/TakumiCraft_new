...
public class TCChaseCreeper extends AbstractTCCreeper {
    ...
    public static class TCChaseCreeperContext implements TCCreeperContext<TCChaseCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCChaseCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
