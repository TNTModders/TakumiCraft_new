...
public class TCBoltCreeper extends AbstractTCCreeper {
    ...
    public static class TCBoltCreeperContext implements TCCreeperContext<TCBoltCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCBoltCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
