...
public class TCAmethystCreeper extends AbstractTCCreeper {
    ...
    public static class TCAmethystCreeperContext implements TCCreeperContext<TCAmethystCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCAmethystCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TCEntityCore.TCEntityId(NAME));
