...
public class TCBlazeCreeper extends AbstractTCCreeper {
    ...
    public static class TCBlazeCreeperContext implements TCCreeperContext<TCBlazeCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCBlazeCreeper::new, MobCategory.MONSTER).fireImmune().sized(0.6F, 1.8F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
