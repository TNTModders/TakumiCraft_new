...
public class TCRewriteCreeper extends AbstractTCCreeper {
    ...
    public static class TCRewriteCreeperContext implements TCCreeperContext<TCRewriteCreeper> {
        ...
        public static final EntityType<? extends AbstractTCCreeper> CREEPER = EntityType.Builder.of(TCRewriteCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(TakumiCraftCore.MODID + ":" + NAME);
