...
public class TCAmethystBomb extends ThrowableItemProjectile {
    public static final EntityType<TCAmethystBomb> AMETHYST_BOMB = EntityType.Builder.<TCAmethystBomb>of(TCAmethystBomb::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build(TakumiCraftCore.MODID + ":amethystbomb");
    ...
    public TCAmethystBomb(Level p_37399_, LivingEntity p_37400_) {
        super(AMETHYST_BOMB, p_37400_, p_37399_);
    }

    public TCAmethystBomb(Level p_37394_, double p_37395_, double p_37396_, double p_37397_) {
        super(AMETHYST_BOMB, p_37395_, p_37396_, p_37397_, p_37394_);
    }
    ...
    public boolean hurt(DamageSource p_19946_, float p_19947_) {
        if (p_19946_.is(DamageTypes.PLAYER_ATTACK)) {
            this.discard();
        }
