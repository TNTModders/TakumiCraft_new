...
public class TCBirdBomb extends ThrowableItemProjectile {
    public static final EntityType<TCBirdBomb> BIRD_BOMB = EntityType.Builder.<TCBirdBomb>of(TCBirdBomb::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build(TakumiCraftCore.MODID + ":birdbomb");
    ...
    public TCBirdBomb(double p_37433_, double p_37434_, double p_37435_, Level p_37436_) {
        super(BIRD_BOMB, p_37433_, p_37434_, p_37435_, p_37436_);
    }

    public TCBirdBomb(LivingEntity p_37439_, Level p_37440_) {
        super(BIRD_BOMB, p_37439_, p_37440_);
    }
