...
public class TCCreeperGrenade extends AbstractTCGrenade {
    ...
    public static final EntityType<TCCreeperGrenade> GRENADE = EntityType.Builder.<TCCreeperGrenade>of(TCCreeperGrenade::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build("takumithrowgrenade");
