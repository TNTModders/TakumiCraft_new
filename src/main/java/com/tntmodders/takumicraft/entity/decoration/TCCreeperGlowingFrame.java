...
public class TCCreeperGlowingFrame extends TCCreeperFrame {
    ...
    public static final EntityType<TCCreeperGlowingFrame> GLOWING_FRAME = EntityType.Builder.<TCCreeperGlowingFrame>of(TCCreeperGlowingFrame::new, MobCategory.MISC).sized(0.5F, 0.5F).eyeHeight(0.0F).clientTrackingRange(10).updateInterval(Integer.MAX_VALUE).build("creeperframe_glowing");
