...
public class TCCreeperFrame extends ItemFrame implements ITCTranslator {
    ...
    public static final EntityType<TCCreeperFrame> ITEM_FRAME = EntityType.Builder.<TCCreeperFrame>of(TCCreeperFrame::new, MobCategory.MISC).sized(0.5F, 0.5F).eyeHeight(0.0F).clientTrackingRange(10).updateInterval(Integer.MAX_VALUE).build(TCEntityUtils.TCEntityId("creeperframe"));
