...
public class TCColoredCreeperGlassBlock extends TCCreeperGlassBlock {
    ...
    public TCColoredCreeperGlassBlock(DyeColor colorIn) {
        super("creeperglass_" + colorIn.getName());
        this.color = colorIn;
