...
@OnlyIn(Dist.CLIENT)
public class TCChildCreeperRenderer extends MobRenderer<Creeper, CreeperModel<Creeper>> {
    ...
    @Override
    public void render(Creeper p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) {
