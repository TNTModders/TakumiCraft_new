...
public class TCPigCreeperRenderer extends MobRenderer<TCPigCreeper, TCPigCreeperModel<TCPigCreeper>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(TCPigCreeper p_114482_) {
        return LOCATION;
    }

    @Override
    protected void scale(TCPigCreeper p_114046_, PoseStack p_114047_, float p_114048_) {
        TCClientUtils.scaleSwelling(p_114046_, p_114047_, p_114048_);
    }

    @Override
    protected float getWhiteOverlayProgress(TCPigCreeper p_114043_, float p_114044_) {
