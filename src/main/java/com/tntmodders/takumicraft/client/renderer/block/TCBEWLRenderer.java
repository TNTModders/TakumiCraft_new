    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext p_108831_, PoseStack poseStack, MultiBufferSource bufferSource, int p_108834_, int p_108835_) {
        switch (stack.getItem()) {
            ...
            case TCCreeperShieldItem tcCreeperShieldItem -> {
                ...
                if (flag) {
                    BannerRenderer.renderPatterns(poseStack, bufferSource, p_108834_, p_108835_, this.shieldModel.plate(), material, false, Objects.requireNonNullElse(dyecolor, DyeColor.WHITE), bannerpatternlayers, stack.hasFoil());
                } else {
