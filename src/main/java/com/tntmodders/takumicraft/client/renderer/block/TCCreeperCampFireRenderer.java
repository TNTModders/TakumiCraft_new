...
@OnlyIn(Dist.CLIENT)
public class TCCreeperCampFireRenderer implements BlockEntityRenderer<TCCreeperCampFireBlockEntity> {
    private static final float SIZE = 0.375F;
    private final ItemRenderer itemRenderer;

    public TCCreeperCampFireRenderer(BlockEntityRendererProvider.Context p_173602_) {
        this.itemRenderer = p_173602_.getItemRenderer();
    }

    @Override
    public void render(TCCreeperCampFireBlockEntity p_112344_, float p_112345_, PoseStack p_112346_, MultiBufferSource p_112347_, int p_112348_, int p_112349_) {
